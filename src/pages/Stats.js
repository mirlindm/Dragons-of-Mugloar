...
export const Stats = (props) => {
    return (
        <div>
            <StyledGameIntro className="flex-row-item-one game-name" > <StyledStatsLabels> Game <StyledStatsValues> {props.gameId.gameId} </StyledStatsValues> has started! </StyledStatsLabels> </StyledGameIntro>            
